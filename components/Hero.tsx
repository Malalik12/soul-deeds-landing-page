    ...
    <section className="relative bg-gradient-to-br from-purple-50 via-white to-white py-16 md:py-20 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 text-center lg:text-left z-10">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight max-w-xl mx-auto lg:mx-0">
            Love shouldn't expire. <br />
            <span className="text-[#8B268F]">Neither should your access.</span>
          </h1>
          <div className="w-24 h-1.5 bg-[#8B268F] my-6 mx-auto lg:mx-0"></div>
          ...
          <div className="bg-purple-100/50 border-l-4 border-[#8B268F] p-4 rounded-r-lg max-w-xl mx-auto lg:mx-0">
        ...
        <div className="lg:w-1/2 w-full mt-12 lg:mt-0 flex justify-center lg:justify-end relative h-[400px] sm:h-[450px] lg:h-[500px]">
          <div className="absolute w-full h-full">
             <img 
                ...
                className="absolute top-0 left-1/2 -translate-x-1/2 lg:left-auto lg:right-1/4 lg:translate-x-0 w-[240px] sm:w-[280px] md:w-[300px] lg:w-[350px] h-auto rounded-3xl transform transition-transform duration-500 hover:scale-105"
              />
          </div>
        </div>
      </div>
